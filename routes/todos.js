...
//Router listening for a GET request on the root todos route '/todos/' file in controller folder
...
// Router listening for a POST request on the '/createBudget' route in '/todos/' file in controller folder
router.post('/createBudget', todosController.createBudget)

//Router listening for a PUT request on the '/markComplete' route in '/todos/' file in controller folder
...
//Router listening for a PUT request on the '/markIncomplete' route in '/todos/' file in controller folder
...
//Router listening for a DELETE request on the '/deleteTodo' route in '/todos/' file in controller folder
